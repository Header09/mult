...
def menu():
	...
	try:
		nama = requests.get("https://graph.facebook.com/me/?access_token="+token).json()["name"].lower()
		ip = b=requests.get("http://ip-api.com/json/").json()["query"]
	...
	if angga =="":
		...
		if useragent == "":
			...
			useragent = ("Mozilla/5.0 (Linux; Android 9; STF-L09 Build/HUAWEISTF-L09; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36[FB_IAB/FB4A;FBAV/[FB_IAB/FB4A;FBAV/300.2.0.58.129;]") 
